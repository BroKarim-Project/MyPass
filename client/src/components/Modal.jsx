export const DeleteModal = ({ onClose, onDelete, onTrashClick }) => {
  const closeModal = () => {
    onClose();
  };
  return (
    <>
      <div id="deleteModal" tabIndex="-1" aria-hidden="true" className="overflow-y-auto overflow-x-hidden fixed transform translate-x-1/3 translate-y-1/3 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
